 ...
 *
 *
 * @method MockProviderHost whenProcotolVersion(float|int|string $version)
 ...
 * @method MockProviderHost whenQuery(array|string $query, bool $regexpOrSubset = false)
 ...
 * @method MockProviderHost andWhenProcotolVersion(float|int|string $version)
 ...
 * @method MockProviderHost andWhenQuery(array|string $query, bool $regexpOrSubset = false)
...
class MockProviderHost implements \Jfalque\HttpMock\ServerInterface
{
    ...
    public function __call($name, $arguments)
    {
        ...
        if (\is_callable([$this->_host, $name])) {
     ...
     *
     * @return null|callable|\Psr\Http\Message\ResponseInterface
     */
     ...
     *
     * @param callable|\Psr\Http\Message\RequestInterface $result
     *
