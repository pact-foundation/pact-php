...
namespace PhpPact\Plugins\Sse\Factory;
...
use PhpPact\Plugins\Sse\Driver\Body\SseBodyDriver;
use PhpPact\Plugins\Sse\Driver\Pact\SsePactDriver;
use PhpPact\Plugins\Sse\Exception\MissingPluginPartsException;
use PhpPact\Standalone\MockService\MockServerConfigInterface;
use PhpPact\Consumer\Service\MockServer;

class SseInteractionDriverFactory implements InteractionDriverFactoryInterface
{
    /**
     * @var InteractionPart[]
     */
    ...
    {
        $client = new Client();
        $pactDriver = new SsePactDriver($client, $config);
        $mockServer = new MockServer($client, $pactDriver, $config);
        $csvBodyDriver = new SseBodyDriver(new PluginBodyDriver($client));
