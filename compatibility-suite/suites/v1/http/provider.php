...
return (new Config())
    ->withProfile((new Profile('default'))
        ->withSuite((new Suite('v1_http_provider', [
            ...
            ->withPaths('%paths.base%/compatibility-suite/pact-compatibility-suite/features/V1/http_provider.feature')));
