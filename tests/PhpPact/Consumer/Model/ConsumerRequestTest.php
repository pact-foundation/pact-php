...
class ConsumerRequestTest extends TestCase
{
    ...
    public function testSerializingWhenPathUsingMatcher()
    {
        ...
        $this->assertEquals('{"pact:matcher:type":"regex","regex":"\\\\\\/somepath\\\\\\/[0-9a-f]{8}(-[0-9a-f]{4}){3}-[0-9a-f]{12}\\\\\\/status","value":"\/somepath\/474d610b-c6e3-45bd-9f70-529e7ad21df0\/status"}', $model->getPath());
