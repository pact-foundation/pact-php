...
class HttpBodyComparerTest extends TestCase
{
    ...
    public function testCompare()
    {
        ...
        // match = true
        $expected = new ProviderServiceRequest("POST", 200, [], "");
        $actual = new ProviderServiceRequest("POST", 200, [], "");
        ...
        $actual = new ProviderServiceRequest("POST", 200, [], false);
        $results = $comparer->Compare($expected, $actual, $matchers);
        ...
        // match = true
        $expected = new ProviderServiceRequest("POST", 200, [], false);
        $actual = new ProviderServiceRequest("POST", 200, [], "{ \"foo\": \"bar\" )");
        $results = $comparer->Compare($expected, $actual, $matchers);
